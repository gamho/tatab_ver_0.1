        ...
        <div class="subWrapper">
            ...
            <div class="sidebar">
                ...
                <div class="sideContent">
                    ...
                    <div class="list"> <!-- 여긴 나중에 forEach로! -->
                        ...
                        <!-- 플젝명 -->
                        <div class="listName">
                            <a href="/tatab/board.do"><h3>플잭1</h3></a>
                        </div>
                        <!-- 플잭명 끝 -->
                    </div>
                    <!-- 플젝 리스트 끝-->
            ...
            <div class="main">
                ...
                <div class="commentBelow">
                    <h1>비트교육센터 장기 프로젝트</h1><br>
                    <h2>비트더비트</h2><br>
                    <p>--------------------------- 여기가 밑에 나오는 일반 코멘트 구역 ---------------------------<br>
                </div>
                <!-- 아래 코멘트 끝 -->
                <!-- 코멘트 수정 아이콘 -->
    ...
    background-repeat: no-repeat;"/>
        ...
        <div id="MainCommentModal" class="MainCommentModal">
            ...
            <div class="MainCommentModalContent">
                <div class="container">
                    <form id="contact" action="UserMain.html" method="post"
                        ...
                        <fieldset>
                            <input placeholder="메인 타이틀" type="text" tabindex="1" required
                                autofocus>
                        </fieldset>
                        <fieldset>
                            <input placeholder="서브 타이틀" type="text" tabindex="1" required
                                autofocus>
                        </fieldset>
                        <fieldset>
                            <textarea rows="30" cols="50" placeholder="코멘트" tabindex="2" required></textarea>
                        </fieldset>
                        <fieldset id="buttons">
                            <input type="submit" class="btn btn-primary" href="UserMain.html" value="수정">
                            <a class="btn btn-light" href="UserMain.html" role="button">취소</a>
                        </fieldset>
                    </form>
                </div>
